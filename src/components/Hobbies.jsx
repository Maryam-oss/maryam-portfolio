...
const Hobbies = ({ data }) => {
    return (
        <section id="hobbies" className="min-h-screen flex flex-col justify-center py-24 px-6 relative">
            <div className="max-w-5xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {data.map((hobby, index) => (
                        <div
                            key={index}
                            className="bg-surface/50 p-8 rounded-3xl border border-white/10 hover:border-accent/30 hover:shadow-xl transition-all duration-300 text-center group"
                        >
