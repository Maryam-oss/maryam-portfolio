...
const Contact = ({ data }) => {
    return (
        <section id="contact" className="min-h-screen flex flex-col justify-center py-24 px-6 bg-gradient-to-t from-surface to-background relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto text-center relative z-10">
                ...
                <div className="bg-surface/80 backdrop-blur-xl p-10 md:p-14 rounded-[2rem] shadow-xl border border-white/10 relative overflow-hidden group hover:border-accent/30 transition-colors duration-500">
                    <div className="space-y-8">
                        <div>
                            <h3 className="text-sm font-bold text-accent tracking-widest uppercase mb-2">Get in Touch</h3>
                            <a href={`mailto:${data.email}`} className="text-2xl md:text-4xl font-bold font-heading text-white hover:text-accent transition-colors relative z-10">
                                {data.email}
                            </a>
                        </div>

                        <div className="flex justify-center gap-10 pt-8">
                            <a href={data.github} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white hover:scale-110 transform transition-all duration-300">
